...
namespace org.denyakicreate.blockcity.gui
{
    public class GUIManager
    {
        ...
        private static string[] tips = new string[] { "メニューはEscキーで戻ることが出来ます", "ポーズメニューはEscキーで開きます", "F2でスクリーンショットを撮ることが出来ます", "スクリーンショットは/AppData/LocalLow/denyakicreative/Block City/screenshots/にあります" };
        ...
        public static void background()
        {
            ...
            while (0 < (left -= AssetsManager.background.width)) ;
            while (0 < (up -= AssetsManager.background.height)) ;
